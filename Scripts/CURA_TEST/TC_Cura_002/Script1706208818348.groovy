...
WebUI.setText(findTestObject('Object Repository/CURA_HOME/OC_Make_Appointment/Page_CURA Healthcare Service/input_password'), 
    findTestData('Login_Data').getValue('Username', 1))

WebUI.setText(findTestObject('Object Repository/CURA_HOME/OC_Make_Appointment/Page_CURA Healthcare Service/input_password'), 
    findTestData('Login_Data').getValue('Password', 1))
...
WebUI.click(findTestObject('Object Repository/CURA_HOME/OC_Make_Appointment/Page_CURA Healthcare Service/td_15'))
...
WebUI.click(findTestObject('Object Repository/CURA_HOME/OC_Make_Appointment/Page_CURA Healthcare Service/h2_Appointment Confirmation'))
